...
// implentation of a RPN calculator with an undo function.
// Stores the previous stack in a stack of stacks of doubles.
...
void undo(stack<double>& numbers, stack<stack<double>>& previous_stacks){
...
int main (int argc, char *argv[]) {
  ...
  stack<stack<double>> previous_stacks;		// a stack of stacks of doubles, to hold previous stacks (for undo function)
  while (!cin.eof()) {
    if (interactive) cout << "> ";
